...
class CommentsTest < ApplicationSystemTestCase
  ...
  #   @user = create(:user)
  #   @story = create(:story)
  #   @comment = create(:comment, :of_story, story: @story)
  #   @user_comment = create(:comment, :of_story, story: @story, user: @user)
  ...
  #   other_story_comment = create(:comment, :of_story, story: create(:story))
  ...
  #     end
  #   end
  #   comment = Comment.where(user: @user, story: @story).where_content(content).take
